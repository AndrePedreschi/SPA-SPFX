  ...
  return (
    <Container>
      <Section>
        ...
        <h2>
          Para começar um projeto com spfx devemos atentar-nos a alguns
          detalhes:
        </h2>
        <p>
          Primeiramente a versão do spfx deve ser compatível com a do node,
          typescript e react, segue site com a{" "}
          <strong>
            <a
              target="_blank"
        ...
        <p>
          Para verificar a versão do node, rodar o seguinte comando no terminal:
          node -v
        </p>
      </Section>
      ...
      <Section>
        ...
        <p>
          Quando o texto `Which type of client-side component to create?`
          aparecer, escolha entre as seguintes opções:
        </p>
        <p>Para criar uma página SPA ou webpart, selecionar a opção WebPart</p>
        <p>
          Ou se for criar uma extensio / aplication customizer, selecionae
          Extension
        </p>
      </Section>
      <Section>
        ...
        <p>
          Esse comando só precisamos rodar 1 vez no projeto e após habilitar o
          certificado rodamos o projeto com o comando:
        </p>
        <p>gulp serve</p>
      </Section>
      <Section>
        ...
        <p>
          O seguinte comando criará um arquivo .sppkg que estará localizado em
          sharepoint/solution dentro do diretório do seu projeto.
        </p>
        ...
        <Img url={deploy3} />
        <p>
          Pós salvar no nosso App Catalog, a aplicação vai estar disponível para
          ser adicionada como uma web part ou para quando formos criar uma
          página nova
        </p>
      </Section>
    </Container>
