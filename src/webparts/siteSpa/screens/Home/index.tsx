...
export function Home(): ReactElement {
	return (
		<Container>
			...
			<Section>
				<H1>Bibliotecas testadas no SPFx que funcionam na versão 1.19, com o react 17:</H1>
				<ul>
					<Paragrafo>
						React-hook-form -{" "}
						<a target="_blank" href="https://react-hook-form.com/" rel="noreferrer">
							Link biblioteca
						</a>
					</Paragrafo>
					<Paragrafo>
					...
					<Paragrafo>
						...
						<a target="_blank" href="https://v5.reactrouter.com/" rel="noreferrer">
							Link biblioteca
						</a>
					</Paragrafo>
					<Paragrafo>Segurança de rotas usando o protected route do react router dom</Paragrafo>
					<Paragrafo>
						Sweet Alert 2 -{" "}
						<a target="_blank" href="https://sweetalert2.github.io/" rel="noreferrer">
							Link biblioteca
						</a>{" "}
					</Paragrafo>
					<Paragrafo>
					...
					<Paragrafo>
						...
						<a target="_blank" href="https://zustand-demo.pmnd.rs/" rel="noreferrer">
							Link biblioteca
						</a>
					</Paragrafo>
					<Paragrafo>
				...
				<ul>
					...
					<Teste>Customização da página com o aplication customizer / extension project</Teste>
				...
				<H1>Extras:</H1>
				<ul>
					<Teste>Exemplos - https://github.com/pnp/sp-dev-fx-extensions/tree/main/samples</Teste>
				</ul>
			</Section>
		</Container>
	);
